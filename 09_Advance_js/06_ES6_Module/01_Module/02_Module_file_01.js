const usersData = [
  ...
  const myName = "Rana Vikram Sinha"
  const myName2 = "Rudraksha"
  const myBrotherName = "Raja Babu"
  const myName3 = "Raiksin" //* while using * in import myName3 will not import, we have to do explicitly export myName3

  export {usersData, myName, myName2, myBrotherName as brother} //* (as) use for rename
  export default usersData

  export function getFirstUserData(){
    return usersData[0]
  }
